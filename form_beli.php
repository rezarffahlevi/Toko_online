...
echo 'Kode Produk : <select style="width:200px" id="states" name="pilih_barang" required="required" onchange="document.getElementById(\'barang_harga\').value = prdName[this.value]">';  
echo '<option>-------</option>';  
