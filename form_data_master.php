					...
					<div class='box-content'>
						  ...
						  <input type=hidden name=inc id=inc value='<?php echo $inc ?>' />
							...
							<select name='unit' class="span6 typeahead field required">
								...
								<option value="<?php echo $tampil3['unit_id']; ?>"><?php echo $tampil3['nama_unit']; ?></option>
								<?php endwhile; ?>
							</select>
							</div>
							...
							<select name='kategori' class="span6 typeahead field required">
								...
								<option value="<?php echo $tampil2['kategori_id']; ?>"><?php echo $tampil2['nama_kategori']; ?></option>
								<?php endwhile; ?>
							</select>
							</div>
							...
							<div class='controls'>
							<input type='text' onkeypress=\"return isNumberKey(event)\" name=diskon class='span6 typeahead field required' id='typeahead' title='field ini harus di isi'>
							</div>

							<div class='control-group'>
							<label class='control-label' for='typeahead'>Gambar Barang </label>
							<div class='controls'>
							
							<input type='file' name='gambar' class='span6 typeahead field required' id='typeahead' title='field ini harus di isi'>
							</div>
					...
					<div class='box-content'>
						<form class='form-horizontal'>
						  ...
						  <input type=hidden name=supplier_inc id=supplier_inc value=$inc />
							...
							<input type='text' name=eceran class='span6 typeahead field required' id='typeahead' title='field ini harus di isi'>
							</div>							
